...
function dTree(objName) {
	...
	this.icon = {
		root		: 'resources/js/img/base.gif',
		folder		: 'resources/js/img/folder.gif',
		folderOpen	: 'resources/js/img/folderopen.gif',
		node		: 'resources/js/img/page.gif',
		empty		: 'resources/js/img/empty.gif',
		line		: 'resources/js/img/line.gif',
		join		: 'resources/js/img/join.gif',
		joinBottom	: 'resources/js/img/joinbottom.gif',
		plus		: 'resources/js/img/plus.gif',
		plusBottom	: 'resources/js/img/plusbottom.gif',
		minus		: 'resources/js/img/minus.gif',
		minusBottom	: 'resources/js/img/minusbottom.gif',
		nlPlus		: 'resources/js/img/nolines_plus.gif',
		nlMinus		: 'resources/js/img/nolines_minus.gif'
	};
